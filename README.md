...
**Версия:** 1.2.0 (см. [CHANGELOG.md](CHANGELOG.md))
...
- Регламент: санитария и проверка оборудования (по расписанию)
- Ответы на вопросы по базе знаний: `/ask`, `/topics` (OpenAI)
...
| /topics | Темы базы знаний (FAQ) |
| /ask … | Вопрос ИИ по FAQ (нужен API-ключ) |
...
| /sanitary_ok | Подтвердить санитарию / уборку |
| /equipment_ok | Подтвердить проверку оборудования |
...
│   ├── scheduler.py
│   ├── status_text.py
│   ├── faq_knowledge.md   # база для /ask (или FAQ_PATH)
│   └── app.py
